...
<div class="grid grid-cols-4">
  <div class="flex flex-col bg-gray-900 shadow-lg h-screen min-w-full text-white items-center">
  ...
  <a href="#" class=" block p-3 hover:bg-gray-800 w-full ">Mes services</a>
  ...
  <div class="flex flex-col  col-span-3  ">
    <div class=" flex bg-gray-800 w-full justify-end items-center space-x-5">
